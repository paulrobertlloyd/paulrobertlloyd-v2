...
if (document.querySelector) {
    // Set up containing .slideshow div (enables swipe.js)
    ...
    // Insert .slideshow div before prose content
    var prose = document.querySelector('.prose');
        prose.insertBefore(slideshow, prose.firstChild);
    ...
    function slideshowInit(slideshow) {
        // Set up swipe slider
        var slider = new Swipe(slideshow, {
            callback: function(event, index, elem) {
                setActivePageLink(pages[index]);
            }
        });
        ...
        slideshow.appendChild(prevNext);
        ...
        for (var i=0; i<slider.length; i++) {
            ...
            var page = document.createElement('a');
                page.href = '#';
                page.innerHTML = i + 1;
                page.setAttribute('data-tab', i);
                page.onclick = function(e) {
                    e.preventDefault();
                    setActivePageLink(this);
                    slider.slide(parseInt(this.getAttribute('data-tab')));
                }
            pagination.appendChild(pageItem);
            pageItem.appendChild(page);
        }
        ...
        var pages = slideshow.querySelectorAll('.pagination a');
            pages[0].className += 'active';

        function setActivePageLink(elem) {
